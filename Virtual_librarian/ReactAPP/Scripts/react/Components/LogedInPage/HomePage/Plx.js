...
const TRANSFORM_MAP = {
    ...
    skew: (value, unit) => `skew(${value}${unit})`,
    skewX: (value, unit) => `skewX(${value}${unit})`,
    skewY: (value, unit) => `skewY(${value}${unit})`,
    skewZ: (value, unit) => `skewZ(${value}${unit})`,
...
// url()
const FILTER_MAP = {
    blur: (value, unit) => `blur(${value}${unit})`,
    brightness: value => `brightness(${value})`,
    contrast: value => `contrast(${value})`,
    grayscale: value => `grayscale(${value})`,
    hueRotate: (value, unit) => `hue-rotate(${value}${unit})`,
