...
var window_scroll_manager_1 = require("window-scroll-manager");
...
// CSS transform map
var TRANSFORM_MAP = {
    rotate: function (value, unit) { return "rotate(" + value + unit + ")"; },
    rotateX: function (value, unit) { return "rotateX(" + value + unit + ")"; },
    rotateY: function (value, unit) { return "rotateY(" + value + unit + ")"; },
    rotateZ: function (value, unit) { return "rotateZ(" + value + unit + ")"; },
    scale: function (value) { return "scale(" + value + ")"; },
    scaleX: function (value) { return "scaleX(" + value + ")"; },
    scaleY: function (value) { return "scaleY(" + value + ")"; },
    scaleZ: function (value) { return "scaleZ(" + value + ")"; },
    skew: function (value, unit) { return "skew(" + value + unit + ")"; },
    skewX: function (value, unit) { return "skewX(" + value + unit + ")"; },
    skewY: function (value, unit) { return "skewY(" + value + unit + ")"; },
    skewZ: function (value, unit) { return "skewZ(" + value + unit + ")"; },
    translateX: function (value, unit) { return "translateX(" + value + unit + ")"; },
    translateY: function (value, unit) { return "translateY(" + value + unit + ")"; },
    translateZ: function (value, unit) { return "translateZ(" + value + unit + ")"; },
};
...
// url()
var FILTER_MAP = {
    blur: function (value, unit) { return "blur(" + value + unit + ")"; },
    ...
    hueRotate: function (value, unit) { return "hue-rotate(" + value + unit + ")"; },
    invert: function (value) { return "invert(" + value + ")"; },
    opacityFilter: function (value) { return "opacity(" + value + ")"; },
    saturate: function (value) { return "saturate(" + value + ")"; },
...
function convertPropToPixels(propName, propValue, maxScroll, offset) {
...
function parallax(scrollPosition, start, duration, startValue, endValue, easing) {
    ...
    // Apply easing
    if (easing) {
        var easingPropType = typeof easing;
        if (easingPropType === 'object' && easing.length === 4) {
            percentage = bezier_easing_1.default(easing[0], easing[1], easing[2], easing[3])(percentage);
        }
        else if (easingPropType === 'string' && EASINGS[easing]) {
            percentage = bezier_easing_1.default(EASINGS[easing][0], EASINGS[easing][1], EASINGS[easing][2], EASINGS[easing][3])(percentage);
        }
...
function applyProperty(scrollPosition, propertyData, startPosition, duration, style, easing) {
    var startValue = propertyData.startValue, endValue = propertyData.endValue, property = propertyData.property, unit = propertyData.unit;
...
function getNewState(scrollPosition, props, state, element) {
    var animateWhenNotInViewport = props.animateWhenNotInViewport, disabled = props.disabled, freeze = props.freeze, parallaxData = props.parallaxData;
    var showElement = state.showElement, plxStyle = state.plxStyle, plxStateClasses = state.plxStateClasses;
    ...
    var _loop_1 = function (i) {
        var _a = parallaxData[i], duration = _a.duration, easing = _a.easing, endOffset = _a.endOffset, properties = _a.properties, startOffset = _a.startOffset;
    ...
    segments.forEach(function (data) {
        var easing = data.easing, durationInPx = data.durationInPx, properties = data.properties, startInPx = data.startInPx;
        properties.forEach(function (propertyData) {
            var property = propertyData.property;
...
var Plx = /** @class */ (function (_super) {
    __extends(Plx, _super);
    function Plx(props) {
    ...
    Plx.prototype.componentDidMount = function () {
        // Get scroll manager singleton
        this.scrollManager = new window_scroll_manager_1.default();
        // Add listeners
        window.addEventListener('window-scroll', this.handleScrollChange);
        window.addEventListener('resize', this.handleResize);
        this.update();
    };
    Plx.prototype.componentDidUpdate = function (prevProps) {
        if (prevProps !== this.props) {
            this.update();
        }
    };
    Plx.prototype.componentWillUnmount = function () {
    ...
    Plx.prototype.update = function (scrollPosition) {
        var _this = this;
        if (scrollPosition === void 0) { scrollPosition = null; }
        var currentScrollPosition = scrollPosition === null ?
        ...
        if (newState) {
            ...
            requestAnimationFrame(function () { return _this.setState(newState); });
        }
    };
    Plx.prototype.handleResize = function () {
        var _this = this;
        clearTimeout(this.resizeDebounceTimeoutID);
    ...
    Plx.prototype.handleScrollChange = function (e) {
        this.update(e.detail.scrollPositionY);
    };
    Plx.prototype.render = function () {
        var _this = this;
        var _a = this.props, children = _a.children, className = _a.className, disabled = _a.disabled, style = _a.style, tagName = _a.tagName;
        var _b = this.state, showElement = _b.showElement, plxStyle = _b.plxStyle, plxStateClasses = _b.plxStateClasses;
        var Tag = tagName;
        var elementStyle = style;
        if (!disabled) {
            elementStyle = __assign({}, style, plxStyle, { 
        ...
        return (<Tag {...omit(this.props, PROPS_TO_OMIT)} className={"Plx " + plxStateClasses + " " + className} style={elementStyle} ref={function (el) { return _this.element = el; }}>
                {children}
            </Tag>);
    };
    return Plx;
...
exports.default = Plx;
var propertiesItemType = prop_types_1.default.shape({
    startValue: prop_types_1.default.oneOfType([
        prop_types_1.default.string,
        prop_types_1.default.number,
    ]).isRequired,
    endValue: prop_types_1.default.oneOfType([
        prop_types_1.default.string,
        prop_types_1.default.number,
    ]).isRequired,
    property: prop_types_1.default.string.isRequired,
...
var parallaxDataType = prop_types_1.default.shape({
    start: prop_types_1.default.oneOfType([
        prop_types_1.default.string,
        prop_types_1.default.number,
        prop_types_1.default.instanceOf(SafeHTMLElement),
    ]).isRequired,
    startOffset: prop_types_1.default.oneOfType([
        prop_types_1.default.string,
        prop_types_1.default.number,
    ]),
    duration: prop_types_1.default.oneOfType([
        prop_types_1.default.string,
        prop_types_1.default.number,
        prop_types_1.default.instanceOf(SafeHTMLElement),
    ]),
    end: prop_types_1.default.oneOfType([
        prop_types_1.default.string,
        prop_types_1.default.number,
        prop_types_1.default.instanceOf(SafeHTMLElement),
    ]),
    endOffset: prop_types_1.default.oneOfType([
        prop_types_1.default.string,
        prop_types_1.default.number,
    ]),
    properties: prop_types_1.default.arrayOf(propertiesItemType).isRequired,
    easing: prop_types_1.default.oneOfType([
        prop_types_1.default.string,
...
Plx.propTypes = {
    animateWhenNotInViewport: prop_types_1.default.bool,
    children: prop_types_1.default.any,
    className: prop_types_1.default.string,
    disabled: prop_types_1.default.bool,
    freeze: prop_types_1.default.bool,
    parallaxData: prop_types_1.default.arrayOf(parallaxDataType),
    style: prop_types_1.default.objectOf(prop_types_1.default.oneOfType([prop_types_1.default.string, prop_types_1.default.number, prop_types_1.default.object])),
...
//# sourceMappingURL=../../../../../Components/LogedInPage/HomePage/Plx.js.map